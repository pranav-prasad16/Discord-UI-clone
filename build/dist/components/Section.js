...
import studyGroup from '../assets/invite_only_landing.svg.proxy.js';
import justChilling from '../assets/just_chiling_landing.svg.proxy.js';
import hangingOut from '../assets/hanging_out_easy_landing.svg.proxy.js';
import fandomLanding from '../assets/fandom_landing.svg.proxy.js';
import tinyStartlanding from '../assets/tiny_stars_landing.svg.proxy.js';
import usaFlag from '../assets/usa_flag.png.proxy.js';
import WhiteBackground from '../supports/WhiteBackground.js';
import { ChevronDownIcon, DownloadIcon } from '../../_snowpack/pkg/@heroicons/react/outline.js';
import { Link } from '../../_snowpack/pkg/react-router-dom.js';
const Section = () => {
  return /*#__PURE__*/React.createElement("div", {
    className: "font-ginto"
  }, /*#__PURE__*/React.createElement("div", {
    className: "w-full px-4 py-[120px]"
  }, /*#__PURE__*/React.createElement("div", {
    className: "w-10/12 mx-auto grid gap-x-[20px] gap-y-0 grid-cols-4 md:grid-cols-12"
  }, /*#__PURE__*/React.createElement("img", {
    src: studyGroup,
    alt: "study groupd",
    className: "col-span-full md:col-span-7"
  }), /*#__PURE__*/React.createElement("div", {
    className: "md:col-start-9 md:col-span-4 col-span-full flex flex-col"
  }, /*#__PURE__*/React.createElement("h2", {
    className: "font-bold text-xl md:text-5xl leading-[120%] mt-9"
  }, "Create an invite only place where you belong"), /*#__PURE__*/React.createElement("p", {
    className: "mt-6 leading-7 text-base md:text-xl"
  }, "Discord servers are organized into topic-based channels where you can collaborate, share, and just talk about your day without clogging up a group chat.")))), /*#__PURE__*/React.createElement("div", {
    className: "w-full px-4 py-[120px] bg-[#f6f6f6]"
  }, /*#__PURE__*/React.createElement("div", {
    className: "w-10/12 mx-auto grid gap-x-[20px] gap-y-0 grid-cols-4 md:grid-cols-12"
  }, /*#__PURE__*/React.createElement("div", {
    className: "col-start-1 col-span-full md:col-span-4 flex flex-col mt-7"
  }, /*#__PURE__*/React.createElement("h2", {
    className: "font-bold text-xl md:text-4xl leading-[120%] mt-9"
  }, "Where hanging out is easy"), /*#__PURE__*/React.createElement("p", {
    className: "mt-6 leading-7 text-base md:text-xl"
  }, "Grab a seat in a voice channel when you\u2019re free. Friends in your server can see you\u2019re around and instantly pop in to talk without having to call.")), /*#__PURE__*/React.createElement("img", {
    src: hangingOut,
    alt: "hanging out",
    className: "col-span-full md:col-start-6 md:col-span-7"
  }))), /*#__PURE__*/React.createElement("div", {
    className: "w-full px-4 py-[120px] font-ginto"
  }, /*#__PURE__*/React.createElement("div", {
    className: "w-10/12 mx-auto grid gap-x-[20px] gap-y-0 grid-cols-4 md:grid-cols-12"
  }, /*#__PURE__*/React.createElement("img", {
    src: fandomLanding,
    ...
    className: "col-span-full md:col-start-9 md:col-span-4 flex flex-col"
  }, /*#__PURE__*/React.createElement("h2", {
    className: "font-bold text-xl md:text-5xl leading-[120%] mt-9"
  }, "From few to a fandom"), /*#__PURE__*/React.createElement("p", {
    className: "mt-6 leading-7 text-base md:text-xl"
  }, "Get any community running with moderation tools and custom member access. Give members special powers, set up private channels, and more.")))), /*#__PURE__*/React.createElement("div", {
    className: "w-full px-4 py-[120px] bg-[#f6f6f6]"
  }, /*#__PURE__*/React.createElement("div", {
    className: "w-10/12 mx-auto grid gap-x-[20px] gap-y-0 grid-cols-4 md:grid-cols-12"
  }, /*#__PURE__*/React.createElement("div", {
    className: "flex flex-col md:col-start-2 md:col-span-10 col-span-full text-center"
  }, /*#__PURE__*/React.createElement("h2", {
    className: "text-3xl md:text-[40px] font-ginto"
  }, "Reliable tech for staying close"), /*#__PURE__*/React.createElement("div", {
    className: "text-base md:text-lg mt-6 font-thin"
  }, "Low-latency voice and video feels like you\u2019re in the same room. Wave hello over video, watch friends stream their games, or gather up and have a drawing session with screen share.")), /*#__PURE__*/React.createElement("img", {
    src: justChilling,
    alt: "just chilling",
    className: "col-start-1 col-span-full"
  }))), /*#__PURE__*/React.createElement("div", {
    className: "w-full px-4 pb-[120px] bg-[#f6f6f6]"
  }, /*#__PURE__*/React.createElement("div", {
    className: "w-10/12 mx-auto"
  }, /*#__PURE__*/React.createElement("div", {
    className: "relative flex flex-col text-center justify-center"
  }, /*#__PURE__*/React.createElement("div", {
    className: "absolute top-0 w-full overflow-hidden z-0 select-none"
  }, /*#__PURE__*/React.createElement("img", {
    src: tinyStartlanding,
    alt: "stars over heading",
    className: "select-none max-w-none w-[600px] mx-auto"
  })), /*#__PURE__*/React.createElement("h4", {
    className: "relative z-1 mt-8 text-3xl font-bold"
  }, "Ready to start your journey?"), /*#__PURE__*/React.createElement("div", {
    className: "relative z-1 mx-auto mt-8"
  }, /*#__PURE__*/React.createElement(WhiteBackground, null, /*#__PURE__*/React.createElement("button", {
    className: "flex flex-row justify-center items-center px-8 py-[1.3rem] text-white bg-[#5865F2] hover:bg-[#5f6bf1] hover:shadow-xl transition-all"
  }, /*#__PURE__*/React.createElement(DownloadIcon, {
    className: "w-6 mx-2"
  }), /*#__PURE__*/React.createElement("p", null, "Download for Linux"))))))), /*#__PURE__*/React.createElement("div", {
    className: "w-full bg-gray-900 text-white py-16 flex flex-col justify-center items-center"
  }, /*#__PURE__*/React.createElement("div", {
    className: "grid-cols-4 md:col-start-1 md:col-span-4 grid md:grid-cols-12 md:grid-rows-1 w-10/12 font-ginto"
  }, /*#__PURE__*/React.createElement("div", {
    className: "flex flex-col col-span-full md:col-span-3"
  }, /*#__PURE__*/React.createElement("h4", {
    className: "text-4xl text-[#5865F2] font-bold"
  }, "Imagine a Place"), /*#__PURE__*/React.createElement("div", {
    className: "text-white flex flex-row items-center text-sm"
  }, /*#__PURE__*/React.createElement("img", {
    src: usaFlag,
    alt: "usa flag",
    className: "w-6 mr-2"
    ...
    className: "mr-2"
  }, "English, USA"), /*#__PURE__*/React.createElement(ChevronDownIcon, {
    className: "w-4"
  })), /*#__PURE__*/React.createElement("div", {
    ...
    className: "col-span-full md:col-start-5 md:col-span-full grid grid-cols-4 md:grid-cols-8 grid-rows-2 md:grid-rows-1 mt-8 md:mt-0"
  }, /*#__PURE__*/React.createElement("div", {
    className: "col-start-1 col-span-2 md:col-start-1 md:col-span-2"
  }, /*#__PURE__*/React.createElement("ul", {
    className: "text-sm font-thin "
  }, /*#__PURE__*/React.createElement("li", {
    className: "hover:text-[#5865f2] text-[#5865f2] cursor-pointer"
  }, "Product"), /*#__PURE__*/React.createElement("li", {
    className: "hover:text-[#5865f2] cursor-pointer mt-4"
  }, "Download"), /*#__PURE__*/React.createElement("li", {
    className: "hover:text-[#5865f2] cursor-pointer mt-4"
  }, "Nitro"), /*#__PURE__*/React.createElement("li", {
    className: "hover:text-[#5865f2] cursor-pointer mt-4"
  }, "Status"))), /*#__PURE__*/React.createElement("div", {
    className: "col-start-3 col-span-2 md:col-start-3 md:col-span-2"
  }, /*#__PURE__*/React.createElement("ul", {
    className: "text-sm font-thin"
  }, /*#__PURE__*/React.createElement("li", {
    className: "hover:text-[#5865f2] text-[#5865f2] cursor-pointer"
    ...
    className: "hover:text-[#5865f2] cursor-pointer mt-4"
  }, "Branding"), /*#__PURE__*/React.createElement("li", {
    className: "hover:text-[#5865f2] cursor-pointer mt-4"
  }, "Newsroom"))), /*#__PURE__*/React.createElement("div", {
    className: "row-start-2 md:row-start-1 col-span-2 md:col-start-5 md:col-span-2"
  }, /*#__PURE__*/React.createElement("ul", {
    className: "text-sm font-thin"
  }, /*#__PURE__*/React.createElement("li", {
    className: "hover:text-[#5865f2] text-[#5865f2] cursor-pointer"
  }, "Resources"), /*#__PURE__*/React.createElement("li", {
    className: "hover:text-[#5865f2] cursor-pointer mt-4"
  }, "College"), /*#__PURE__*/React.createElement("li", {
    className: "hover:text-[#5865f2] cursor-pointer mt-4"
  }, "Support"), /*#__PURE__*/React.createElement("li", {
    className: "hover:text-[#5865f2] cursor-pointer mt-4"
  }, "Safety"), /*#__PURE__*/React.createElement("li", {
    className: "hover:text-[#5865f2] cursor-pointer mt-4"
  }, "Blog"), /*#__PURE__*/React.createElement("li", {
    className: "hover:text-[#5865f2] cursor-pointer mt-4"
  }, "Feedback"), /*#__PURE__*/React.createElement("li", {
    className: "hover:text-[#5865f2] cursor-pointer mt-4"
  }, "Developers"), /*#__PURE__*/React.createElement("li", {
    className: "hover:text-[#5865f2] cursor-pointer mt-4"
  }, "Streamkits"))), /*#__PURE__*/React.createElement("div", {
    className: ""
  }, /*#__PURE__*/React.createElement("ul", {
    className: "text-sm font-thin"
  }, /*#__PURE__*/React.createElement("li", {
    className: "hover:text-[#5865f2] text-[#5865f2] cursor-pointer"
  }, "Policies"), /*#__PURE__*/React.createElement("li", {
    className: "hover:text-[#5865f2] cursor-pointer mt-4"
  }, "Terms"), /*#__PURE__*/React.createElement("li", {
    className: "hover:text-[#5865f2] cursor-pointer mt-4"
  }, "Policies"), /*#__PURE__*/React.createElement("li", {
    className: "hover:text-[#5865f2] cursor-pointer mt-4"
  }, "Cookie Settings"), /*#__PURE__*/React.createElement("li", {
    className: "hover:text-[#5865f2] cursor-pointer mt-4"
  }, "Guidelines"), /*#__PURE__*/React.createElement("li", {
    className: "hover:text-[#5865f2] cursor-pointer mt-4"
  }, "Acknowledgements"), /*#__PURE__*/React.createElement("li", {
    className: "hover:text-[#5865f2] cursor-pointer mt-4"
  }, "Licenses"), /*#__PURE__*/React.createElement("li", {
    className: "hover:text-[#5865f2] cursor-pointer mt-4"
  }, "Moderation"))))), /*#__PURE__*/React.createElement("div", {
    className: "flex flex-row justify-between items-center w-10/12 mt-8"
  }, /*#__PURE__*/React.createElement("div", {
    ...
    className: "font-ginto text-white text-xl font-bold mt-1"
  }, "Discord")), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(WhiteBackground, null, /*#__PURE__*/React.createElement("button", {
    className: "bg-[#5865f2] px-4 py-2 text-white text-sm"
