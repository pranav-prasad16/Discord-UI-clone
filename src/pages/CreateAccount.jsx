            ...
            <div className='bg-[#36393F] sm:rounded-md absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 lg:w-[784px] w-full max-w-screen-sm h-screen sm:h-auto sm:max-w-[480px] lg:max-w-[784px] p-8 transition-all'>
                <div className='flex flex-row justify-between'>
                    <div className='w-full'>
                        ...
                        <div>
                            <div className='mt-6'>
                                <h5 className='text-sm leading-4 mb-2 text-gray-400'>EMAIL</h5>
                                <div className='w-full'>
                                    <input type="email" className='bg-[#303339] pl-2 outline-slate-900 border-none outline-none outline-1 outline-offset-0 rounded-sm px-1 py-2 text-gray-300 focus:outline-[#00aff4] w-full transition-all' />
                                </div>
                            </div>
                            <div className='mb-2 mt-6'>
                                <h5 className='text-sm leading-4 mb-2 text-gray-400'>USERNAME</h5>
                                <div className='w-full'>
                            ...
                            <button className='bg-[#5865F2] border-none w-full text-white py-3 rounded-sm mt-4'>Continue</button>
                            <div className='text-gray-500 text-sm'>
                                <p><span className='text-[#00aff4] ml-1'><Link to='/login'>Already have an account?</Link> </span></p>
                            </div>
                        </div>
                    </div>
                </div>
